...
function readTableHeaders() {
  const tableHeaders = document.getElementById("dataTable");
  const headerElements = tableHeaders.querySelectorAll("thead th");
  headers = Array.from(headerElements).map((header) => header.textContent);
}
