<div class="flex flex-row justify-between items-center mb-6">
    <p class="font-semibold text-lg text-slate-500">New Student</p>
...
<div class="">
    <form action="/students/save" method="post">
        ...
        <div class=" relative mb-6">
            <input type="text" name="stnumber" id="stnumber" class="px-4 py-3 peer w-full border focus:outline-none focus:ring-2 focus:border-brand focus:ring-brand/20 rounded-md border-slate-700/10 placeholder:text-transparent" placeholder="stnumber" />
        ...
        <div class=" relative mb-6">
            <input type="text" name="fname" id="fname" class="px-4 py-3 peer w-full border focus:outline-none focus:ring-2 focus:border-brand focus:ring-brand/20 rounded-md border-slate-700/10 placeholder:text-transparent" placeholder="fname" />
        ...
        <div class=" relative mb-6">
            <input type="text" name="mname" id="mname" class="px-4 py-3 peer w-full border focus:outline-none focus:ring-2 focus:border-brand focus:ring-brand/20 rounded-md border-slate-700/10 placeholder:text-transparent" placeholder="mname" />
            <label for="mname" class="absolute left-0 ml-2 px-1 -translate-y-3 bg-white text-sm duration-100 ease-linear peer-placeholder-shown:translate-y-3 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-500 peer-focus:ml-2 peer-focus:-translate-y-3 peer-focus:px-1 peer-focus:text-sm">Middle Name </label>
        </div>
        <div class=" relative mb-6">
            <input type="text" name="lname" id="lname" class="px-4 py-3 peer w-full border focus:outline-none focus:ring-2 focus:border-brand focus:ring-brand/20 rounded-md border-slate-700/10 placeholder:text-transparent" placeholder="lname" />
        ...
        <div class=" relative mb-6">
            <input type="email" name="email" id="email" class="px-4 py-3 peer w-full border focus:outline-none focus:ring-2 focus:border-brand focus:ring-brand/20 rounded-md border-slate-700/10 placeholder:text-transparent" placeholder="email" />
        ...
        <div class=" relative mb-6">
            <select name="curr" id="curr" class="px-4 py-3 peer w-full border focus:outline-none focus:ring-2 focus:border-brand focus:ring-brand/20 rounded-md border-slate-700/10 placeholder:text-transparent">
                ...
                ?>
                    <option value="<?= $curriculum->getId() ?>"><?= $curriculum->getName() ?></option>
                <?php } ?>
            </select>
