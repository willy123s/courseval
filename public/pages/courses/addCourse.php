<div class="flex flex-row justify-between items-center mb-6">
    <p class="font-semibold text-lg text-slate-500">New Course</p>
...
<div class="">
    <form action="/courses/save" method="post">
        ...
        <div class="relative mb-6">
            <input type="text" name="course" id="course" class="px-4 py-3 peer w-full border focus:outline-none focus:ring-2 focus:border-brand focus:ring-brand/20 rounded-md border-slate-700/10 placeholder:text-transparent" placeholder="Course" />
