                ...
                <tbody class="divide-y divide-slate-700/10 " id="tableBody">
                    ...
                    ?>
                        <tr class="transition-all">
                            <td class="px-2 py-3"><a href="#" data-remote="/proofs/v/<?= $p->getId() ?>" data-size="w-full" class="pop hover:text-blue-500 hover:underline">Proof of Grade</a></td>
                            <td class="px-2 py-3"><?= $p->getSY() ?></td>
                            <td class="px-2 py-3"><?= $p->getSem() ?></td>
