...
<div class="px-8">
    <div class="bg-white p-6 rounded-xl shadow-lg shadow-black/5 border border-slate-700/10">
        <div class="mb-4">
            <a href="#" data-remote="/schoolyears/create" data-size="w-full md:w-2/5 lg:w-1/5" class="pop px-3 py-2 text-sm bg-brand hover:bg-brand-dark rounded-md text-slate-100 transition-all">Add School Year</a>
        </div>
        ...
        <div class="">
                ...
                <tbody class="divide-y divide-slate-700/10 " id="tableBody">
                    ...
                    ?>
                        <tr class="transition-all">
                            <td class="px-2 py-3"><?= $sy->getSchoolyear() ?></td>
                            <td class="px-2 py-3"><?= $sy->getStatus() ?></td>
                            <td class="px-2 py-3 flex flex-row item-center gap-2">
                                <a href="#" data-remote="/schoolyears/edit/<?= $sy->getId() ?>" data-size="w-full md:w-2/5 lg:w-1/5" class="pop text-sm bg-brand-dark hover:bg-brand-light transition-all text-slate-200 p-1 rounded-md">
            ...
            <div class="flex flex-row justify-between">
                <div class="">
                    <p>(<?= sizeof($schoolyears) ?>) Record(s)</p>
                </div>
