...
<div class="">
    <form action="/grades/save" method="post">
        ...
        <div class="relative mb-6">
            <input type="text" name="grade" id="grade" class="px-4 py-3 peer w-full border focus:outline-none focus:ring-2 focus:border-brand focus:ring-brand/20 rounded-md border-slate-700/10 placeholder:text-transparent" placeholder="grade" />
